...
python3 dataset_test.py dataset.name="reddit" general.name="reddit_debug" model.transition="uniform" general.gpus=[0] train.batch_size=12 train.accumulate_grad_batches=4 general.setting='train_scratch' train.n_epochs=1
